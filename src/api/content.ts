import type { HomeContent, ProductCategory, ProductDetail, ProductListResult, SearchContentType, SearchGroup, SearchResult, SiteDetail, SiteFilters, SiteListResult, SiteStage, StaffDetail, WarrantyDetail, WarrantyListResult } from '../types/domain'
