...
<style scoped>.page{min-height:100vh;padding-bottom:calc(110rpx + env(safe-area-inset-bottom));background:#f4f6f4}.categories{white-space:nowrap;background:#fff;border-bottom:1rpx solid #e8ece9}.category-row{display:flex;gap:14rpx;padding:22rpx 28rpx}.category-row button{flex:none;margin:0;padding:0 26rpx;height:62rpx;line-height:62rpx;border-radius:32rpx;border:0;background:#eef2ef;color:#65756f;font-size:23rpx}.category-row button::after,.card::after,.load-more::after{border:0}.category-row .active{background:#1f5a4d;color:#fff}.grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:20rpx;padding:26rpx}.card{min-width:0;margin:0;padding:0;overflow:hidden;border-radius:20rpx;text-align:left;line-height:normal;background:#fff;box-shadow:0 8rpx 24rpx rgba(31,62,53,.06)}.card image{display:block;width:100%;height:240rpx}.body{padding:18rpx 22rpx 22rpx}.product-topline{display:flex;align-items:center;justify-content:space-between;gap:10rpx;overflow:hidden}.product-category{flex:none;max-width:55%;padding:6rpx 10rpx;overflow:hidden;border-radius:8rpx;color:#245c50;background:#e5f0ed;font-size:18rpx;font-weight:600;line-height:1.4;white-space:nowrap;text-overflow:ellipsis}.price-note{min-width:0;overflow:hidden;color:#b17632;font-size:18rpx;line-height:1.4;white-space:nowrap;text-overflow:ellipsis}.name,.summary{display:block}.name{margin-top:13rpx;color:#203a33;font-size:29rpx;font-weight:650;line-height:1.35}.summary{display:-webkit-box;margin-top:6rpx;overflow:hidden;color:#778680;font-size:22rpx;line-height:1.45;-webkit-line-clamp:2;-webkit-box-orient:vertical}.card-more{margin-top:12rpx;color:#9a703e;font-size:22rpx;font-weight:600;line-height:1.4}.card-more text{font-size:28rpx}.load-more{grid-column:1 / -1;min-height:88rpx;margin:12rpx auto 0;padding:0 32rpx;border:1rpx solid #b9c8c3;border-radius:44rpx;color:#245c50;background:transparent;font-size:26rpx;line-height:normal;display:flex;align-items:center;justify-content:center}.end{grid-column:1 / -1;padding:20rpx;text-align:center;color:#99a5a1;font-size:22rpx}@media(max-width:360px){.grid{grid-template-columns:1fr}.card image{height:340rpx}}</style>
